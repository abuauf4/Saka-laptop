...
// ─── Jakarta Laptops — LP Section: FAQ ───
// Style 100% konsisten dengan src/components/home/faq-section.tsx

import { useState } from "react";
import { ChevronDown } from "lucide-react";
import type { LandingPageData } from "@/lib/landing-page-data";

export function LpFaqSection({ content }: { content: LandingPageData }) {
